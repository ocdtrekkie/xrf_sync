...
echo "<table><tr><td width=50><b>ID</b></td><td width=200><b>Friendly Name</b></td><td width=50><b>Pool</b></td><td width=200><b>Last Seen</b><td width=200><b>Last IP Address</b></td></tr>";
$qq=0;
while ($qq < $num) {
...
echo "<tr><td>$id</td><td>$descr</td><td>$pool_id</td><td>$last_seen</td><td>$last_ip_addr</td></tr>";
$qq++;
}
